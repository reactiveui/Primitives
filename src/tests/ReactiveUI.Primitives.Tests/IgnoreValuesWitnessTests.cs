...
/// <summary>Tests forwarding terminal notifications while dropping values.</summary>
public class IgnoreValuesWitnessTests
{
    /// <summary>Errors still reach the observer when values are ignored, and release the subscription.</summary>
    ...
    public async Task OnError_ForwardsErrorAndDisposesSubscription()
    {
        ...
        using IgnoreValuesWitness<int> witness = new(observer);
