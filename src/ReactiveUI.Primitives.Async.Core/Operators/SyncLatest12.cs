...
/// <summary>Provides the arity-12 (<c>twelve</c>-source) <c>CombineLatest</c> extension methods.</summary>
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>Combines the latest values from 12 asynchronous observable sources into a single sequence, projecting them through <paramref name="selector"/> whenever any source emits.</summary>
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(
            ...
            new SyncLatest12Signal<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(
