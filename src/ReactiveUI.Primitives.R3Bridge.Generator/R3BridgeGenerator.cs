...
{
    /// <summary>Assembly metadata emitted during post initialization so consumers can identify generated bridge output.</summary>
    private const string MarkerSource = """
                                        // <auto-generated />
                                        [assembly: global::System.Reflection.AssemblyMetadata("ReactiveUI.Primitives.R3Bridge.Generator", "0.1.0")]
                                        """;
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput(static output =>
            output.AddSource(
                "PrimitivesR3BridgeGeneratorMetadata.g.cs",
