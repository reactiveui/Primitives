...
public static partial class SignalAsync
{
    ...
    public static IObservableAsync<T> ToAsyncSignal<T>(this Task<T> @this) => CreateAsBackgroundJob<T>(
    ...
    [SuppressMessage(
        ...
        "RCS1047:Non-asynchronous method name should not end with \'Async\'",
        Justification = "This is an existing method")]
    public static IObservableAsync<RxVoid> ToAsyncSignal(this Task @this) => CreateAsBackgroundJob<RxVoid>(
        async (obs, cancellationToken) =>
        {
    ...
    [SuppressMessage(
        ...
        "RCS1047:Non-asynchronous method name should not end with \'Async\'",
        Justification = "This is an existing method")]
    public static IObservableAsync<T> ToAsyncSignal<T>(this IAsyncEnumerable<T> @this) => CreateAsBackgroundJob<T>(
        async (obs, cancellationToken) =>
        {
    ...
    [SuppressMessage(
        ...
        "RCS1047:Non-asynchronous method name should not end with \'Async\'",
        Justification = "This is an existing method")]
    public static IObservableAsync<T> ToAsyncSignal<T>(this IEnumerable<T> @this) => CreateAsBackgroundJob<T>(
