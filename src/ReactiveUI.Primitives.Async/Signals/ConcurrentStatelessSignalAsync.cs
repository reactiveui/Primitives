...
public sealed class ConcurrentStatelessSignalAsync<T> : BaseStatelessSignalAsync<T>
{
    ...
    /// <summary>Notifies all specified observers of an error and resumes processing asynchronously.</summary>
