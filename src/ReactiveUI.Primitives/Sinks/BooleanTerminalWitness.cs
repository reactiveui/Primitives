...
public abstract class BooleanTerminalWitness<T> : SingleSourceWitness<T>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="BooleanTerminalWitness{T}"/> class.</summary>
    /// <param name="observer">The downstream observer.</param>
    protected BooleanTerminalWitness(IObserver<bool> observer) => _observer = observer;
