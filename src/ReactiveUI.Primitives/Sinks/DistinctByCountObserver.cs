...
public sealed class DistinctByCountObserver<T, TKey> : SingleSourceObserver<T>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="DistinctByCountObserver{T,TKey}"/> class.</summary>
    /// <param name="observer">The downstream observer.</param>
    /// <param name="keySelector">The key selector.</param>
    /// <param name="comparer">The key comparer.</param>
    public DistinctByCountObserver(IObserver<int> observer, Func<T, TKey> keySelector, IEqualityComparer<TKey>? comparer)
    {
        _observer = observer;
