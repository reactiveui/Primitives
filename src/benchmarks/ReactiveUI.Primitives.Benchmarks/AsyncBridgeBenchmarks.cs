...
/// <summary>Benchmarks for async-to-stream adapters.</summary>
[MemoryDiagnoser]
public class AsyncBridgeBenchmarks
{
    /// <summary>The value produced by the pre-completed task used as the bridge source.</summary>
    private const int CompletedTaskValue = 42;

    /// <summary>A pre-completed task that yields <see cref="CompletedTaskValue"/>.</summary>
    private static readonly Task<int> CompletedTask = Task.FromResult(CompletedTaskValue);

    /// <summary>Baseline conversion from completed task in primitives.</summary>
    ...
    /// <summary>Completed task conversion in System.Reactive.</summary>
    /// <returns>The emitted value.</returns>
    [Benchmark]
    ...
    /// <summary>Completed task conversion in R3.</summary>
    /// <returns>The emitted value.</returns>
    [Benchmark]
