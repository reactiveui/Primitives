...
/// <summary>Async witness that tallies notifications and exposes the next value and the completion as tasks.</summary>
/// <typeparam name="T">The observed element type.</typeparam>
[DebuggerDisplay("AsyncTallyWitness: Count = {_count}, Errors = {_errorCount}")]
internal sealed class AsyncTallyWitness<T> : IWitnessAsync<T>
{
