...
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>
        /// Combines the latest values from 11 asynchronous observable sources into a single
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
            ...
            new SyncLatest11SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
        ...
        [SuppressMessage(
            ...
            "S107:Methods should not have too many parameters",
            Justification = "Has more than 7 parameters - just expected for arity-N CombineLatest operator surface.")]
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
            IObservableAsync<T2> src2,
            IObservableAsync<T3> src3,
            IObservableAsync<T4> src4,
            IObservableAsync<T5> src5,
            ...
            IObservableAsync<T11> src11,
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, src7, src8, src9, src10, src11, selector);
    }

    /// <summary>Async observable that combines the latest values from eleven source sequences using a selector.</summary>
    ...
    internal sealed class SyncLatest11SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
        SyncLatest11SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
        ...
        internal sealed class SyncLatestCoordinator : SyncLatestCoordinatorBase<TResult>
        {
            ...
            internal override ValueTask EmitLatestAsync() =>
                TryReadValues(out var values)
                    ? Lifecycle.EmitDownstreamAsync(_selector(values.V1, values.V2, values.V3, values.V4, values.V5, values.V6, values.V7, values.V8, values.V9, values.V10, values.V11))
                    : default;
