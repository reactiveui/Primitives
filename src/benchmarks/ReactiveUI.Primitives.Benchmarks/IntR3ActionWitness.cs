...
/// <summary>Minimal R3 observer for benchmarks that only need subscription lifecycle handling.</summary>
internal sealed class IntR3ActionWitness : Observer<int>
{
    /// <summary>The optional per-value callback, or <see langword="null"/> for a no-op observer.</summary>
    private readonly Action<int>? _onNext;

    /// <summary>Initializes a new instance of the <see cref="IntR3ActionWitness"/> class.</summary>
