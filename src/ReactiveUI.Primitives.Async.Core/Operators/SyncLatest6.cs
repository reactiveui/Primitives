...
/// <summary>Provides the arity-6 (<c>six</c>-source) <c>CombineLatest</c> extension methods.</summary>
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>Combines the latest values from 6 asynchronous observable sources into a single sequence, projecting them through <paramref name="selector"/> whenever any source emits.</summary>
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, TResult>(
            ...
            new SyncLatest6Signal<T1, T2, T3, T4, T5, T6, TResult>(
