...
/// <summary>Coordinates subscriptions and latest-value emission for the arity-11 <c>SyncLatest</c> operator.</summary>
...
public sealed class SyncLatest11Coordinator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult> : SyncLatestCoordinatorBase<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="SyncLatest11Coordinator{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult}"/> class.</summary>
    ...
    public SyncLatest11Coordinator(
    ...
    protected override ValueTask<IAsyncDisposable> SubscribeAtAsync(int index, CancellationToken cancellationToken) =>
        index switch
        {
            ...
            _ => Sources.Source11.SubscribeAsync(Observer11, cancellationToken),
        };
