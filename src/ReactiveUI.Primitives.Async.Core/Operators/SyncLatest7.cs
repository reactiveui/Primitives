...
public static partial class SignalAsyncExtensions
{
    ...
    extension<T1>(IObservableAsync<T1> src1)
    {
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, TResult>(
            ...
            new SyncLatest7SignalAsync<T1, T2, T3, T4, T5, T6, T7, TResult>(
        ...
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, T7, TResult>(
            ...
            IObservableAsync<T7> src7,
            Func<T1, T2, T3, T4, T5, T6, T7, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, src7, selector);
    }
    ...
    internal sealed class SyncLatest7SignalAsync<T1, T2, T3, T4, T5, T6, T7, TResult>(
        SyncLatest7SignalAsync<T1, T2, T3, T4, T5, T6, T7, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
