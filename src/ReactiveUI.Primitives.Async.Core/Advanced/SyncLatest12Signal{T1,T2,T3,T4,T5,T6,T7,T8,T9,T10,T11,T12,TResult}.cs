...
public sealed class SyncLatest12Signal<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> : IObservableAsync<TResult>
{
    /// <summary>Initializes a new instance of the <see cref="SyncLatest12Signal{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult}"/> class.</summary>
    ...
    public SyncLatest12Signal(SyncLatest12State<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> sources, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> selector)
    {
        Sources = sources;
        Selector = selector;
    }
    ...
    private SyncLatest12State<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Sources { get; }

    /// <summary>Gets the selector that projects the latest values.</summary>
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> Selector { get; }
    ...
    {
        SyncLatest12Coordinator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> subscription = new(observer, Sources, Selector);
