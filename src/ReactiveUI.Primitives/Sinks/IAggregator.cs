...
[SuppressMessage("Design", "CA1005:AvoidExcessiveParametersOnGenericTypes", Justification = "Self type parameter keeps the functional Add allocation-free (no boxing).")]
