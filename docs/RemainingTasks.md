...
Updated: 16 September 2026. Audited against `OccasionallyConnected` at `0e4d66b`, retained worktree drafts and available CI results. The feature is not yet ready for an end-to-end application. Requirements follow [the design document](ReactiveUI.Primitives.OccasionallyConnected.md).
