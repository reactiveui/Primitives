...
/// <summary>Signal that emits the final accumulation of the source values.</summary>
/// <typeparam name="TSource">The source value type.</typeparam>
/// <typeparam name="TAccumulate">The accumulated value type.</typeparam>
[System.Diagnostics.DebuggerDisplay("ReduceSignal: Source = {_source}")]
public sealed class ReduceSignal<TSource, TAccumulate> : IObservable<TAccumulate>
{
