...
/// <summary>Signal that projects the latest values of two sources once both have produced one.</summary>
/// <typeparam name="TLeft">The left value type.</typeparam>
/// <typeparam name="TRight">The right value type.</typeparam>
/// <typeparam name="TResult">The result value type.</typeparam>
[System.Diagnostics.DebuggerDisplay("CombineLatestSignal: Left = {_left}, Right = {_right}")]
public sealed class CombineLatestSignal<TLeft, TRight, TResult> : IObservable<TResult>
{
    ...
    public CombineLatestSignal(IObservable<TLeft> left, IObservable<TRight> right, Func<TLeft, TRight, TResult> selector)
    {
