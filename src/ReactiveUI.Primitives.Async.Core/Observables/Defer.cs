...
/// <summary>Provides factory methods for creating observable sequences that are generated by invoking a specified function each time a new observer subscribes.</summary>
...
public static partial class SignalAsync
{
    ...
    /// <summary>Returns an observable sequence that is created by invoking the specified factory function each time a new observer subscribes.</summary>
    /// <typeparam name="T">The type of the elements produced by the observable sequence.</typeparam>
    ...
    /// <summary>Backs <see cref="Defer{T}(Func{IObservableAsync{T}})"/>: each subscribe calls the factory and hands the wrapped observer to the sequence it returns.</summary>
    ...
    /// <summary>Backs the <see cref="ValueTask"/>-returning <see cref="Defer{T}(Func{CancellationToken, ValueTask{IObservableAsync{T}}})"/>, awaiting the factory before it can subscribe.</summary>
    /// <typeparam name="T">The element type.</typeparam>
    /// <param name="factory">The deferred factory invoked once per subscribe.</param>
