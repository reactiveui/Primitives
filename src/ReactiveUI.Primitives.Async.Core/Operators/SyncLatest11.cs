...
/// <summary>Provides the arity-11 (<c>eleven</c>-source) <c>CombineLatest</c> extension methods.</summary>
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>Combines the latest values from 11 asynchronous observable sources into a single sequence, projecting them through <paramref name="selector"/> whenever any source emits.</summary>
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
            ...
            new SyncLatest11Signal<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TResult>(
