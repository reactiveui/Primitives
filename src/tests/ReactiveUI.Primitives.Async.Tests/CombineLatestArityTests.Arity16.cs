...
public partial class CombineLatestArityTests
{
    ...
    public async Task WhenCombineLatest16SubscriptionThrows_ThenDisposesAndRethrows()
    {
        ...
        await Assert.That(async () => await s1.Values.CombineLatest(
            ...
            s15.Values,
            throwingSrc,
            (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16) => v1 + v2 + v3 + v4 + v5 + v6 +
                    v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14 + v15 + v16).SubscribeAsync((_, _) => default, null))
    ...
    public async Task WhenCombineLatest16DisposedBeforeCombine_ThenOnNextCombinedIsGuarded()
    {
        ...
        var sub = await s1.Values.CombineLatest(
            ...
            s16.Values,
            (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16) => v1 + v2 + v3 + v4 + v5 + v6 +
                v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14 + v15 + v16).SubscribeAsync(
            (x, _) =>
            {
                results.Add(x);
                return default;
    ...
    public async Task WhenCombineLatest16OneSourceErrors_ThenCombinedErrorForwarded()
    {
        ...
        await using var sub = await s1.Values.CombineLatest(
            ...
            s16.Values,
            (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16) => v1 + v2 + v3 + v4 + v5 + v6 +
                v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14 + v15 + v16).SubscribeAsync((_, _) => default, (ex, _) =>
        {
            receivedError = ex;
    ...
    public async Task WhenCombineLatest16AllSourcesComplete_ThenCombinedCompletes()
    {
        ...
        await using var sub = await s1.Values.CombineLatest(
            ...
            s16.Values,
            (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15, v16) => v1 + v2 + v3 + v4 + v5 + v6 +
                v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14 + v15 + v16).SubscribeAsync((_, _) => default, null, r =>
        {
