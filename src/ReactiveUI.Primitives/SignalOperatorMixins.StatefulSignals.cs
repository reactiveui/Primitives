...
public static partial class LinqMixins
{
    ...
    /// <typeparam name="T">The value type.</typeparam>
    private sealed class KeepNotNullObserver<T> : SingleSourceObserver<T?>
        where T : class
    {
        ...
        internal KeepNotNullObserver(IObserver<T> observer) => _observer = observer;
    ...
    /// <typeparam name="TResult">The result value type.</typeparam>
    private sealed class KeepTypeObserver<TResult> : SingleSourceObserver<object?>
    {
        /// <summary>The downstream observer.</summary>
        private readonly IObserver<TResult> _observer;

        /// <summary>Initializes a new instance of the <see cref="KeepTypeObserver{TResult}"/> class.</summary>
        /// <param name="observer">The downstream observer.</param>
        internal KeepTypeObserver(IObserver<TResult> observer) => _observer = observer;
