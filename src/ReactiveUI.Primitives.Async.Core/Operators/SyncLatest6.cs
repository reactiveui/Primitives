...
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>
        /// Combines the latest values from 6 asynchronous observable sources into a single
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, TResult>(
            ...
            new SyncLatest6SignalAsync<T1, T2, T3, T4, T5, T6, TResult>(
        ...
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, TResult>(
            ...
            IObservableAsync<T6> src6,
            Func<T1, T2, T3, T4, T5, T6, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, selector);
    }
    ...
    internal sealed class SyncLatest6SignalAsync<T1, T2, T3, T4, T5, T6, TResult>(
        SyncLatest6SignalAsync<T1, T2, T3, T4, T5, T6, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
