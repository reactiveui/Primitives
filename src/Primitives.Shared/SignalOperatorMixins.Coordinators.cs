...
public static partial class LinqExtensions
{
    ...
    /// <summary>Dedicated signal for task-source <c>Chain</c>/<c>Concat</c> overloads.</summary>
    /// <typeparam name="T">The task result type.</typeparam>
    private sealed class TaskChainSignal<T> : IObservable<T>
    {
        ...
        internal TaskChainSignal(IObservable<Task<T>> sources) => _sources = sources;
    ...
    /// <typeparam name="T">The task result type.</typeparam>
    private sealed class TaskChainCoordinator<T> : IDisposable
    {
        ...
        internal TaskChainCoordinator(IObserver<T> observer) => _observer = observer;
        ...
        internal TaskChainCoordinator<T> Run(IObservable<Task<T>> sources)
        {
