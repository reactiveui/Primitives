...
/// <summary>Represents a scheduled work item based on the materialization of an ISequencer.Schedule method call.</summary>
    ...
    where TAbsolute : IComparable<TAbsolute>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="ScheduledItem{TAbsolute, TValue}"/> class. Creates a materialized work item.</summary>
    ...
    /// <summary>Invokes the scheduled action with the supplied recursive scheduler and state.</summary>
