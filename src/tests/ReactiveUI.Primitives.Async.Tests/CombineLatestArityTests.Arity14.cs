...
public partial class CombineLatestArityTests
{
    ...
    public async Task WhenCombineLatest14DisposedBeforeCombine_ThenOnNextCombinedIsGuarded()
    {
        ...
        var sub = await s1.Values.CombineLatest(
            ...
            s14.Values,
            static (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14) =>
                v1 + v2 + v3 + v4 + v5 + v6 + v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14).SubscribeAsync(RecordValues(results), null);
        await EmitSeedAndPlaceValuesAsync(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14);
    ...
    public async Task WhenCombineLatest14AllSourcesEmit_ThenSelectorResultEmitted()
    {
        ...
        await using var sub = await s1.Values.CombineLatest(
            ...
            s14.Values,
            static (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14) =>
                v1 + v2 + v3 + v4 + v5 + v6 + v7 + v8 + v9 + v10 + v11 + v12 + v13 + v14).SubscribeAsync(RecordAndSignalValues(results, emitted), null);
        await EmitSeedAndPlaceValuesAsync(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14);
        ...
        await CompleteAllAsync(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14);
    }
