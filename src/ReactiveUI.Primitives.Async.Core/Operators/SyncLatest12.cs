...
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>
        /// Combines the latest values from 12 asynchronous observable sources into a single
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(
            ...
            new SyncLatest12SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(
        ...
        [SuppressMessage(
            ...
            "S107:Methods should not have too many parameters",
            Justification = "Has more than 7 parameters - just expected for arity-N CombineLatest operator surface.")]
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(
            IObservableAsync<T2> src2,
            IObservableAsync<T3> src3,
            IObservableAsync<T4> src4,
            IObservableAsync<T5> src5,
            ...
            IObservableAsync<T12> src12,
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, src7, src8, src9, src10, src11, src12, selector);
    }

    /// <summary>Async observable that combines the latest values from twelve source sequences using a selector.</summary>
    ...
    internal sealed class SyncLatest12SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>(
        SyncLatest12SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
        ...
        internal sealed class SyncLatestCoordinator : SyncLatestCoordinatorBase<TResult>
        {
            ...
            private readonly SyncLatestIndexedWitness<T5, TResult> _obs5;

            /// <summary>Indexed observer for source 6.</summary>
            private readonly SyncLatestIndexedWitness<T6, TResult> _obs6;

            /// <summary>Indexed observer for source 7.</summary>
            private readonly SyncLatestIndexedWitness<T7, TResult> _obs7;

            /// <summary>Indexed observer for source 8.</summary>
            private readonly SyncLatestIndexedWitness<T8, TResult> _obs8;

            /// <summary>Indexed observer for source 9.</summary>
            private readonly SyncLatestIndexedWitness<T9, TResult> _obs9;

            /// <summary>Indexed observer for source 10.</summary>
            private readonly SyncLatestIndexedWitness<T10, TResult> _obs10;

            /// <summary>Indexed observer for source 11.</summary>
            private readonly SyncLatestIndexedWitness<T11, TResult> _obs11;

            /// <summary>Indexed observer for source 12.</summary>
            private readonly SyncLatestIndexedWitness<T12, TResult> _obs12;
            ...
            internal override ValueTask EmitLatestAsync() =>
                TryReadValues(out var values)
                    ? Lifecycle.EmitDownstreamAsync(_selector(values.V1, values.V2, values.V3, values.V4, values.V5, values.V6, values.V7, values.V8, values.V9, values.V10, values.V11, values.V12))
                    : default;
