...
/// <summary>Coordinates subscriptions and latest-value emission for the arity-9 <c>SyncLatest</c> operator.</summary>
...
public sealed class SyncLatest9Coordinator<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : SyncLatestCoordinatorBase<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="SyncLatest9Coordinator{T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult}"/> class.</summary>
    ...
    public SyncLatest9Coordinator(
        IObserverAsync<TResult> observer,
        SyncLatest9State<T1, T2, T3, T4, T5, T6, T7, T8, T9> sources,
    ...
    private SyncLatest9State<T1, T2, T3, T4, T5, T6, T7, T8, T9> Sources { get; }

    /// <summary>Gets the selector that projects the latest values.</summary>
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> Selector { get; }
    ...
    protected override ValueTask<IAsyncDisposable> SubscribeAtAsync(int index, CancellationToken cancellationToken) =>
        index switch
        {
            ...
            _ => Sources.Source9.SubscribeAsync(Observer9, cancellationToken),
        };
