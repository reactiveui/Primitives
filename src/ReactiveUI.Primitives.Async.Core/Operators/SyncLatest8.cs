...
public static partial class SignalAsyncExtensions
{
    ...
    extension<T1>(IObservableAsync<T1> src1)
    {
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, TResult>(
            ...
            new SyncLatest8SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
        ...
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, T7, T8, TResult>(
            ...
            IObservableAsync<T8> src8,
            Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, src7, src8, selector);
    }

    /// <summary>Async observable that combines the latest values from eight source sequences using a selector.</summary>
    ...
    internal sealed class SyncLatest8SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, TResult>(
        SyncLatest8SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
