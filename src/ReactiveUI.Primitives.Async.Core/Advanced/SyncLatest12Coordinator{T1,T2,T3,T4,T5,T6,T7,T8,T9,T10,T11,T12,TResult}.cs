...
/// <summary>Coordinates subscriptions and latest-value emission for the arity-12 <c>SyncLatest</c> operator.</summary>
        ...
        TResult> : SyncLatestCoordinatorBase<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="SyncLatest12Coordinator{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult}"/> class.</summary>
    ...
    public SyncLatest12Coordinator(
        IObserverAsync<TResult> observer,
        SyncLatest12State<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> sources,
    ...
    protected override ValueTask<IAsyncDisposable> SubscribeAtAsync(int index, CancellationToken cancellationToken) =>
        index switch
        {
            ...
            _ => Sources.Source12.SubscribeAsync(new SyncLatestWitness<T12, TResult>(this, Source12Bit, value => Value12 = new(value)), cancellationToken)
        };
    ...
    private bool TryReadValues(
        out (T1 V1, T2 V2, T3 V3, T4 V4, T5 V5, T6 V6, T7 V7, T8 V8, T9 V9, T10 V10, T11 V11, T12 V12) values)
    {
