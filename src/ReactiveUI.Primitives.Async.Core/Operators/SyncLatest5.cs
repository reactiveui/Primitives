...
public static partial class SignalAsyncExtensions
{
    ...
    extension<T1>(IObservableAsync<T1> src1)
    {
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, TResult>(
            ...
            new SyncLatest5SignalAsync<T1, T2, T3, T4, T5, TResult>(
        ...
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, TResult>(
            ...
            IObservableAsync<T5> src5,
            Func<T1, T2, T3, T4, T5, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, selector);
    }

    /// <summary>Async observable that combines the latest values from five source sequences using a selector.</summary>
    ...
    internal sealed class SyncLatest5SignalAsync<T1, T2, T3, T4, T5, TResult>(
        SyncLatest5SignalAsync<T1, T2, T3, T4, T5, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
