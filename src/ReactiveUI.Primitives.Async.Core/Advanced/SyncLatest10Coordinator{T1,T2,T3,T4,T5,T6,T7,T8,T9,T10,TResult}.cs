...
/// <summary>Coordinates subscriptions and latest-value emission for the arity-10 <c>SyncLatest</c> operator.</summary>
...
public sealed class
    SyncLatest10Coordinator<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> : ISyncLatestCoordinator<TResult>
{
    ...
    /// <summary>Initializes a new instance of the <see cref="SyncLatest10Coordinator{T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult}"/> class.</summary>
    ...
    public SyncLatest10Coordinator(
    ...
    private SyncLatest10State<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Sources { get; }

    /// <summary>Gets the selector that projects the latest values.</summary>
    private Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> Selector { get; }
    ...
    public ValueTask<IAsyncDisposable> SubscribeAtAsync(int index, CancellationToken cancellationToken) =>
        index switch
        {
            ...
            _ => Sources.Source10.SubscribeAsync(new SyncLatestWitness<T10, TResult>(this, Source10Bit, value => Value10 = new(value)), cancellationToken)
        };
