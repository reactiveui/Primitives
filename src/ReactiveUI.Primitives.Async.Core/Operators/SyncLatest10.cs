...
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>
        /// Combines the latest values from 10 asynchronous observable sources into a single
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(
            ...
            new SyncLatest10SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(
        ...
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(
            ...
            IObservableAsync<T10> src10,
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, src7, src8, src9, src10, selector);
    }

    /// <summary>Async observable that combines the latest values from ten source sequences using a selector.</summary>
    ...
    internal sealed class SyncLatest10SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>(
        SyncLatest10SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
        ...
        internal sealed class SyncLatestCoordinator : SyncLatestCoordinatorBase<TResult>
        {
            ...
            internal override ValueTask EmitLatestAsync() =>
                TryReadValues(out var values)
                    ? Lifecycle.EmitDownstreamAsync(_selector(values.V1, values.V2, values.V3, values.V4, values.V5, values.V6, values.V7, values.V8, values.V9, values.V10))
                    : default;
