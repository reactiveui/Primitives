...
public static partial class SignalAsyncExtensions
{
        ...
        : SignalAsync<TResult>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            var subscription = new EnumerableSyncLatestCoordinator(_sources, observer, resultSelector);
        ...
        internal sealed class IndexedWitness(EnumerableSyncLatestCoordinator parent, int index) : IObserverAsync<TSource>
        {
            /// <inheritdoc/>
        ...
        /// <param name="resultSelector">The result selector.</param>
        internal sealed class EnumerableSyncLatestCoordinator(
