...
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>Combines the latest values from 14 asynchronous observable sources into a single sequence, projecting them through <paramref name="selector"/> whenever any source emits.</summary>
