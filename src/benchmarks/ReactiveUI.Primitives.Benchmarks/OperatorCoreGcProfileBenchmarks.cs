...
public class OperatorCoreGcProfileBenchmarks
{
    ...
    /// <summary>The delegate target for the flat-map scenarios.</summary>
    private readonly OperatorFlatMapRangeBenchmarks _flatMap = new();

    /// <summary>The delegate target for the zip scenarios.</summary>
    private readonly OperatorZipBenchmarks _zip = new();

    /// <summary>The delegate target for the start-with/append/default-if-empty scenarios.</summary>
