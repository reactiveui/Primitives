...
internal sealed class ChainSignalSourcesSignal<T>(IObservableAsync<IObservableAsync<T>> source) : SignalAsync<T>
{
    ...
    internal sealed class ChainCoordinator : IAsyncDisposable
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ChainCoordinator"/> class.</summary>
        /// <param name="observer">The downstream observer to forward elements to.</param>
        public ChainCoordinator(IObserverAsync<T> observer)
        {
            _observer = observer;
