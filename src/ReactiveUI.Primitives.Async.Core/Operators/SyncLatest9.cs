...
public static partial class SignalAsyncExtensions
{
    ...
    {
        /// <summary>
        /// Combines the latest values from 9 asynchronous observable sources into a single
        ...
        public IObservableAsync<TResult> SyncLatest<T2, T3, T4, T5, T6, T7, T8, T9, TResult>(
            ...
            new SyncLatest9SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(
        ...
        [SuppressMessage(
            ...
            "S107:Methods should not have too many parameters",
            Justification = "Has more than 7 parameters - just expected for arity-N CombineLatest operator surface.")]
        public IObservableAsync<TResult> CombineLatest<T2, T3, T4, T5, T6, T7, T8, T9, TResult>(
            IObservableAsync<T2> src2,
            IObservableAsync<T3> src3,
            IObservableAsync<T4> src4,
            IObservableAsync<T5> src5,
            ...
            IObservableAsync<T9> src9,
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> selector) =>
            src1.SyncLatest(src2, src3, src4, src5, src6, src7, src8, src9, selector);
    }

    /// <summary>Async observable that combines the latest values from nine source sequences using a selector.</summary>
    ...
    internal sealed class SyncLatest9SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>(
        SyncLatest9SignalAsync<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>.Sources sources,
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> selector) : IObservableAsync<TResult>
    {
        /// <inheritdoc/>
        ...
        internal sealed class SyncLatestCoordinator : SyncLatestCoordinatorBase<TResult>
        {
            ...
            internal override ValueTask EmitLatestAsync() =>
                TryReadValues(out var values)
                    ? Lifecycle.EmitDownstreamAsync(_selector(values.V1, values.V2, values.V3, values.V4, values.V5, values.V6, values.V7, values.V8, values.V9))
                    : default;
